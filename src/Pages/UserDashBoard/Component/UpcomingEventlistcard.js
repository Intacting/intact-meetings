...
const UpcomingEventlistcard = (props)=>{
      ...
      <div className="event-list">
        <div>
          ...
          <div className="event-list-content">
            <button className="event-list-a event-list-b event-list-c" type="button" data-toggle="collapse" data-target="#collapseExample1" aria-expanded="false" aria-controls="collapseExample1">
